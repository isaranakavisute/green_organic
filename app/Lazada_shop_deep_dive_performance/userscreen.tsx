          ...
          <div className="flex flex-row h-1/10 w-full bg-blue">
            <div className="flex flex-row w-1/2 h-full bg-white justify-start items-center">
             <div   
              ...
              <div className="text-4xl font-extrabold pl-2">Lazada Deep Dive Performance</div>
            </div>
              ...
              <div className="flex flex-col h-full w-1/2 bg-white mr-2 justify-start items-start">
               ...
               <div className="flex flex-row w-full">
                <div className="flex flex-row w-full ml-2 mr-2 bg-gray-200">
                  ...
                  <div className="flex flex-row w-1/5 justify-end items-center">Target</div>
                  <div className="flex flex-row w-1/5 justify-end items-center">Actual</div>
                  <div className="flex flex-row w-1/5 justify-center items-center">Gap</div>
                  <div className="flex flex-row w-1/5 justify-center items-center">Status</div>
                </div>
               </div>
               <div className="flex flex-row w-full">
                <div className="flex flex-row w-full ml-2 mr-2 bg-white">
                  ...
                  <div className="flex flex-row w-1/5 justify-end items-center">฿12,500,000</div>
                  <div className="flex flex-row w-1/5 justify-end items-center">฿10,500,000</div>
                  <div className="flex flex-row w-1/5 justify-center items-center">-$1,500,000</div>
